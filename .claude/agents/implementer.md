...
- Run `scripts/factory/verify.sh` before reporting. Do not report DONE if it is red.
...
- Report in this shape: STATUS (DONE | DONE_WITH_CONCERNS | NEEDS_CONTEXT | BLOCKED), files changed, commits, test summary, rulings, concerns.
